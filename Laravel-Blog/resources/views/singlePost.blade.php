            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{route('category.single',['id'=>$post->category_id])}}">{{$post->category->name}}
                                               </a>
                    ...
                    <div class="widget w-tags">
                                ...
                                <a href="{{route('tag.single',['id' => $tag->id]) }}"  class="w-tags-item">{{$tag->name}}
                          @endforeach
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img style="border-radius:40px;" src="{{$post->user->profile->avatar}}" alt="Author">
                    </div>
