            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <a href="{{route('post.single',['slug' => $first_post->slug])}}" class="link-image js-zoom-image">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{route('category.single',['id'=> $first_post->category_id])}}">{{$first_post->category->name}}</a>
                                        </span>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="{{ route('post.single', ['slug' => $second_post->slug ]) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.single',['id'=> $second_post->category_id])}}">{{$second_post->category->name}}</a>
                                        </span>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="{{ route('post.single', ['slug' => $third_post->slug ]) }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.single',['id'=> $third_post->category_id])}}">{{$third_post->category->name}}</a>
                                        </span>
